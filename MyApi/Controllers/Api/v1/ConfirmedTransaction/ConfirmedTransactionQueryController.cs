...
{
    [ApiVersion("1")]
    public class ConfirmedTransactionQueryController : BaseBusinessCommandController<ConfirmedTransaction, ConfirmedTransactionDTO, ConfirmedTransactionVM, ConfirmedTransactionSearch, int>
    {
