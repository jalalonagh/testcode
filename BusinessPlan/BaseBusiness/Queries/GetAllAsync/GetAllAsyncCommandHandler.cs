...
{
    public class GetAllAsyncCommandHandler<TEntity, TDTO, TSearch, TKey> : IQueryHandler<GetAllAsyncCommand<TEntity, TDTO, TSearch, TKey>, ServiceResult<IEnumerable<TEntity>>>
