...
namespace Data.Migrations
{
    ...
    [Migration("20210627045237_init_supplier")]
    partial class init_supplier
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.User.ChairToUser.ChairToUser", b =>
                {
                    ...
                    b.Property<DateTime>("DateDm")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 27, 9, 22, 36, 834, DateTimeKind.Local).AddTicks(2041));

                    b.Property<string>("DateDs")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
                        .HasDefaultValue("1400/04/06");
            ...
            modelBuilder.Entity("SupplierSystem.Entities.Barecode.Barcode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SupplierSystem.Entities.Supplier.Barecode.SupplierBarecode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SupplierBarecodes");
                });

            modelBuilder.Entity("SupplierSystem.Entities.Supplier.Request.SupplierSupplyRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("PackingFinishTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<TimeSpan>("TotalDoneTime")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("TotalPackingTime")
                        .HasColumnType("time");
                    ...
                    b.ToTable("SupplierSupplyRequests");
                });

            modelBuilder.Entity("SupplierSystem.Entities.Supplier.Store.Activities.SupplierStoreActivities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SupplierStoreActivities");
                });

            modelBuilder.Entity("SupplierSystem.Entities.Supplier.Store.SupplierStore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("DimensionZ")
                        .HasColumnType("int");

                    b.Property<string>("InDoorAddress")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsActive")
                        .HasColumnType("bit");

                    b.Property<bool>("IsActiveToSale")
                        .HasColumnType("bit");
                    ...
                    b.Property<double>("MaximumCapacityCBM")
                        .HasColumnType("float");

                    b.Property<int>("Order")
                        .HasColumnType("int");

                    b.Property<string>("OutDoorAddress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SupplierSystem.Entities.Supplier.Barecode.SupplierBarecode", b =>
                {
                    b.HasOne("SupplierSystem.Entities.Supplier.Store.SupplierStore", "Store")
                        .WithMany("Barcodes")
